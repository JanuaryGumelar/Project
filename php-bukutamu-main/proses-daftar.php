...
elseif ($cek2==0) {
  ...
  if($ukuran_file <= 1000000){ 
    ...
    if(move_uploaded_file($tmp_file, $path)){ 
      ...
      $query = "INSERT INTO tamu (no_antri, nama, no_nik, tanggal_masuk, keperluan, tanggal_keluar, bertemu, no_tlp, janji, image) 

      VALUES ('$id_antri', '$nama', '$nik', '$tanggal', '$keperluan', '' , '$bertemu', '$nope', '$janji', '$nama_image')";
