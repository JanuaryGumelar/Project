    ...
    <form action="proses-daftar.php" style="border:1px solid #ccc" method="POST" enctype="multipart/form-data">
        <div class="container">
            ...
            <div class="mb-3">
                ...
                <input type="text" autocomplete="off" placeholder="NoNik" name="no_nik" class="form-control"
                    id="exampleFormControlInput1" required>
            </div>
                ...
                <div class="row">
                    <div class="col">
                        <input type="text" class="form-control" autocomplete="off"
                            placeholder="Masukan Kode/Department .." name="bertemu" onkeyup="isi_otomatis('bertemu')"
                            id="bertemu" required>
            ...
            <label for="formFile" class="form-label"><b>Foto Tamu : <b></label><br>
            <input type="file" class="form-control" id="formFile" name="foto" required="required"
