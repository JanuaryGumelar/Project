...
?>
    ...
    if($user['tanggal_keluar'] == 'belum keluar'){
            ...
            <label style="color: #ccc8c8">No Nik </label><br>
            <p id="login" class="fadeIn second "><?php echo $nik?></p>
            ...
            <label style="color: #ccc8c8">No.Hp </label><br>
            <p id="login" class="fadeIn second "><?php echo $nope?></p>
