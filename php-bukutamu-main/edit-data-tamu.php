    ...
    <form action="proses-edit-data-tamu.php" style="border:1px solid #ccc" method="POST" enctype="multipart/form-data"
        ...
        <div class="container">
            ...
            <div class="mb-3">
                ...
                <input type="text" autocomplete="off" placeholder="Masukan Nama Tamu" name="nama" class="form-control"
                    id="exampleFormControlInput1" value="<?php echo $user['nama']?>" required>
            </div>

            <div class="mb-3">
                <label for="exampleFormControlInput1" class="form-label"><b>Keperluan</b></label>
                <input type="text" autocomplete="off" placeholder="Keperluan ..." name="keperluan" class="form-control"
                    id="exampleFormControlInput1" value="<?php echo $user['keperluan']?>" required>
            </div>

            <div class="mb-3">
                <label for="exampleFormControlInput1" class="form-label"><b>No.Hp</b></label>
                <input type="text" autocomplete="off" placeholder="NoHp" name="no_tlp" class="form-control"
                    id="exampleFormControlInput1" value="<?php echo $user['no_tlp']?>" required>
            </div>
            <div class="mb-3">
                <label for="exampleFormControlInput1" class="form-label"><b>No Nik</b></label>
                <input type="text" autocomplete="off" placeholder="No Nik" name="no_nik" class="form-control"
                    id="exampleFormControlInput1" value="<?php echo $user['no_nik']?>" required>
                ...
                <div class="row">
                    <div class="col">
                        <input type="text" class="form-control" autocomplete="off"
                            placeholder="Masukan Kode/Department .." name="bertemu" onkeyup="isi_otomatis()"
                            id="bertemu" value="<?php echo $user['bertemu']?>" required>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="janji" value=0 id="exampleRadios1"
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="janji" value=1 id="exampleRadios2"
                                value="option2">
                    ...
                    <input type="file" class="form-control" id="formFile" name="foto"
                        value="<?php echo $user['image']?>" required="required" accept="image/*;capture=camera">
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        for (var i = 0; i < len; i++) {
                            ...
                            var nik = response[i]['no_nik'];


                            $("#searchResult").append("<li value='" + id + "'>" + name +
                                "'>" + nik +
                                "</li>");
