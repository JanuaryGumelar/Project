...
?>
    ...
    <form action="proses-edit-data-tamu.php" style="border:1px solid #ccc" method="POST" enctype="multipart/form-data"
        ...
        <div class="container">
            ...
            <input type="number" autocomplete="off" class="form-control" id="input exampleFormControlInput1"
                placeholder="Suhu Tubuh Tamu" name="suhu_tubuh" step="0.01" value="" required>

            <label for="formFile" class="form-label"><b>Foto KTP : <b></label><br>
            <input type="file" class="form-control" id="formFile" name="foto" value="" required="required"
