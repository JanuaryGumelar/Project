...
<body>
   ...
   $sql->execute();
    ...
    <div class="container">
      ...
      ?>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="KataKunci" name="KataKunci" placeholder="Cari Tamu .."
                    required="">
            ...
            ?>
                ...
                <form action='proses-keluar.php' method='POST'>
                    <tr>
                        ...
                        <td><?php echo $noo++?></td>
                        <td><input name="no_antri" class="x" type='hidden' readonly
                                value="<?php echo $data['no_antri']?>"></input><?php echo $b.$a?></td>

                        <td><input name="nama" class="x" type='hidden' readonly
                                value="<?php echo $data['nama']?>"></input><?php echo $data['nama']?></td>

                        <td><input name="no_nik" class="x" type='hidden' readonly
                                value="<?php echo $data['no_nik']?>"></input><?php echo $data['no_nik']?></td>

                        <td> <input name="tanggal_masuk" class="x" type="hidden" readonly style="width: 170px;"
                                value="<?php echo $data['tanggal_masuk']?>"></input> <?php echo $data['tanggal_masuk']?>
                        </td>

                        <td> <input class="x" type="hidden" name="tanggal_keluar" readonly
                                value="<?php echo $keluar?>"></input>
                            <p style="text-align:center"><?php echo $keluar?></p>
                        </td>

                        <td> <input class="x" type="hidden" name="keperluan" readonly
                                value="<?php echo $data['keperluan']?>"></input><?php echo $data['keperluan']?> </td>


                        <td> <input class="x" type="hidden" name="bertemu" readonly
                                value="<?php echo $data['bertemu']?>"></input><?php echo $data['bertemu']?> </td>


                        <td><input class="x" type="hidden" name="janji" readonly
                                value="<?php echo $janji?>"><?php echo $janji?></td>

                        <td> <input class="x" type="hidden" name="No.Hp" readonly
                                value="<?php echo $data['no_tlp']?>"></input><?php echo $data['no_tlp']?> </td>


                        <td> <input class="x" type="hidden" name="total" readonly
                                value="<?php echo $data['total']?>"><?php echo $data['total']?></td>
    ...
    ?>
      ...
      ?>
                        <li><a
                                href="data-tamu-keluar.php?Kolom=<?php echo $kolomCari;?>&KataKunci=<?php echo $kolomKataKunci;?>&page=<?php echo $LinkPrev;?>">Previous</a>
                        </li>
                        <?php
         } 
      }
    ?>
      ...
      for($i = $startNumber; $i <= $endNumber; $i++){
        ...
        if($kolomCari=="" && $kolomKataKunci==""){
    ?>
                        <li<?php echo $linkActive; ?>><a
                                href="data-tamu-keluar.php?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>

                            <?php
      }else{
        ?>
                            <li<?php echo $linkActive; ?>><a
                                    href="data-tamu-keluar.php?Kolom=<?php echo $kolomCari;?>&KataKunci=<?php echo $kolomKataKunci;?>&page=<?php echo $i; ?>"><?php echo $i; ?></a>
                                </li>
                                <?php
      }
    }
    ...
    ?>
     ...
     if($kolomCari=="" && $kolomKataKunci==""){
        ?>
                                <li><a href="data-tamu-keluar.php?page=<?php echo $linkNext; ?>">Next</a></li>
                                <?php     
        }else{
      ?>
                                <li><a
                                        href="data-tamu-keluar.php?Kolom=<?php echo $kolomCari;?>&KataKunci=<?php echo $kolomKataKunci;?>&page=<?php echo $linkNext; ?>">Next</a>
                                </li>
                                <?php
      }
    }
