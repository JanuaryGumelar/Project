...
<title>Buku Tamu SMKN 1 Subang</title>
<meta charset="UTF-8">
...
<body>
    ...
    <icon type="icon" src="img/icon.png" />
    </icon>
    <?php 
include "config.php";
include "akses.php";
...
?>
    ...
    ?>
      ...
      ?>
            <li><a
                    href="home.php?Kolom=<?php echo $kolomCari; ?>&KataKunci=<?php echo $kolomKataKunci;?>&page=<?php echo $LinkPrev;?>">Previous</a>
            </li>
            <?php
         } 
      }
    ...
    ?>
        ...
        ?>
                <li<?php echo $linkActive; ?>><a
                        href="home.php?Kolom=<?php echo $kolomCari;?>&KataKunci=<?php echo $kolomKataKunci;?>&page=<?php echo $i; ?>"><?php echo $i; ?></a>
                    </li>
                    <?php
      }
    }
    ...
    ?>
     ...
     if($kolomCari=="" && $kolomKataKunci==""){
        ?>
                    <li><a href="data-tamu.php">Next</a></li>
                    <?php     
        }else{
      ?>
                    <li><a
